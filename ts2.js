(function () {
    ...
    var IMG_URL     = 'https://img.phimapi.com/';
    ...
    // =====================================================================
    var CATEGORIES = [
        { url: '/v1/api/danh-sach/phim-moi-cap-nhat',   title: 'Phim mới cập nhật' },
    ...
    // =====================================================================
    // FETCH PAGE (đã sửa - hỗ trợ infinite scroll tốt hơn)
    // =====================================================================
    function fetchPage(catUrl, page, onOk, onFail) {
        var net = new Lampa.Reguest();
        var fullUrl = catUrl;
        if (catUrl.indexOf('?') === -1) {
            fullUrl = catUrl + '?page=' + page + '&limit=20';
        } else {
            fullUrl = catUrl + '&page=' + page + '&limit=20';
        }
        ...
        console.log('[KKPhim] Fetching:', fullUrl);
        ...
        net.silent(fullUrl, function (data) {
            ...
            try {
                ...
                console.error('[KKPhim] Lỗi parse data:', e);
            }
            
            console.log('[KKPhim] Loaded', items.length, 'items, page', page, '/', totalPages);
            ...
            console.error('[KKPhim] Lỗi fetch:', err);
    ...
    // =====================================================================
    // COMPONENT: DANH SACH INFINITE SCROLL (đã cải thiện)
    // =====================================================================
    function KKPhimListComponent(object) {
        var catUrl   = object.cat_url || object.url || '/v1/api/danh-sach/phim-moi-cap-nhat';
        ...
        if (catUrl.indexOf('/v1/api/') === -1 && catUrl.indexOf('/danh-sach/') === -1) {
            catUrl = '/v1/api/the-loai/' + catUrl;
        }
        ...
        function loadPage(page) {
            ...
            fetchPage(catUrl, page, function (res) {
                ...
                console.error('[KKPhim] Lỗi tải trang:', err);
                loading = false;
                $loader.hide();
            });
        }
    ...
    // =====================================================================
    // INJECT: THỂ LOẠI (đã sửa - đảm bảo infinite scroll)
    // =====================================================================
