        ...
        if (e.type === 'complite') {
            ...
            setTimeout(function() {
                ...
                if (container.length && !container.find('.btn-ni-mod').length) {
                    var button = $('<div class="full-start__button selector btn-ni-mod">' +
                        ...
                        '<path d="M12 2L4 5V11C4 16.19 7.41 20.92 12 22C16.59 20.92 20 16.19 20 11V5L12 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>' +
                        '</svg>' +
                        '<span>Torrent Ní</span>' +
                    '</div>');
