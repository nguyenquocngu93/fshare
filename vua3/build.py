...
TEMPO=1.15
SEGS=[
 ("p1.jpg","a1.mp3","Hoàng đế này định phong con ngựa của mình làm quan chấp chính La Mã."),
 ("p2.jpg","a2.mp3","Con ngựa tên Incitatus, là ngựa đua yêu quý nhất của hoàng đế Caligula."),
 ("p3.jpg","a3.mp3","Nó sống trong chuồng bằng đá cẩm thạch, ăn trong máng ngà voi, và đeo vòng cổ nạm đá quý."),
 ("p4.jpg","a4.mp3","18 người hầu chăm sóc riêng cho nó. Thức ăn là yến mạch trộn vảy vàng thật."),
 ("p5.jpg","a5.mp3","Con ngựa còn có nhà riêng, có nô lệ, và tự đứng tên mời khách quý tới dự tiệc."),
 ("p6.jpg","a6.mp3","Nhưng con ngựa chưa kịp nhậm chức. Caligula bị ám sát trước đó, khi mới 28 tuổi."),
 ("p7.jpg","a7.mp3","Nhiều sử gia tin đây không phải sự điên rồ, mà là cách sỉ nhục Viện Nguyên Lão. Ý ông là ai cũng làm quan được, kể cả một con ngựa."),
 ("p8.jpg","a8.mp3","Theo dõi để xem tập tiếp theo của series Vua Kỳ Lạ nha!"),
]
def dur(f):
...
"""
L=[f"Dialogue: 0,{ts(0)},{ts(4.0)},Title,,0,0,0,,{{\\an8\\pos(540,290)\\fad(180,200)}}HOÀNG ĐẾ PHONG\\NCON NGỰA LÀM QUAN"]
...
subprocess.run([FF,"-y","-i","mixed.mp4","-vf",f"subtitles=subs.ass:fontsdir={FONTDIR}",
 ...
 "-movflags","+faststart","../vua3_conngua_YOUTUBE.mp4","-loglevel","error"],check=True)
print("DONE")
