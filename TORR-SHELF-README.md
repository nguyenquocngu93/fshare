...
4. Khung bình thường dùng crop giữa `16:11` theo hai vạch đỏ. Khi zoom-out hoàn tất, hero thu về aspect ratio tự nhiên Cinemeta (ảnh full, thường là `16:9`) để backdrop hiển thị đủ 100%, không crop, letterbox, mask hoặc gradient.
