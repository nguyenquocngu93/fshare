...
# Native integration for NB557 Online Mod:
...
for _ in $(seq 1 35); do
  ...
  if [ "$PATCH_STATUS" = '200' ] && curl -fsS --max-time 3 'http://127.0.0.1:9118/online_mod-torrshelf.js?v=3.0' | grep -q 'TORRSHELF_HTTP_ONLINE_MOD_NATIVE_V3'; then
