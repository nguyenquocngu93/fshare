...
function oTSearch(){
    Lampa.Activity.push({url:'',title:'Tìm TMDB',component:'kkphim_tmdb_search',keyword:'',page_num:1});
}
...
Lampa.Component.add('kkphim_source_search',function(obj){
    ...
    function doL(){
        ...
        sSrc(source,kw+' page:'+page).then(function(items){
            spinner.hide();
...
Lampa.Component.add('kkphim_main',function(){
    var scroll=new Lampa.Scroll({mask:true,over:true}),comp=this;
    var currentTab='kkphim'; // kkphim, ophim, tmdb
